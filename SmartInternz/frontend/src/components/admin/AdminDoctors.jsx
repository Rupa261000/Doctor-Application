...
const AdminDoctors = () => {
   ...
   const handleApprove = async (doctorId, status, userid) => {
      ...
      try {
         const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/admin/getapprove`, { doctorId, status, userid }, {
            headers: {
               Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
         })
   ...
   const handleReject = async (doctorId, status, userid) => {
      console.log(doctorId, status, userid)
      try {
         const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/admin/getreject`, { doctorId, status, userid }, {
            headers: {
               Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
         })
